...
def _setup_demo_user_and_client() -> None:
...
def _obtain_authorization_code(client: TestClient, redirect_uri: str, scope: str, state: str) -> tuple[str, str | None]:
...
def test_s1_authorization_code_flow_success_blackbox() -> None:
...
def test_s2_invalid_client_secret_blackbox() -> None:
  _setup_demo_user_and_client()
  client = TestClient(app)
...
def test_s3_invalid_grant_nonexistent_code_blackbox() -> None:
  _setup_demo_user_and_client()
  client = TestClient(app)
